...
namespace CMPM.Spells {
    public class ArcaneBlast : Spell {
        ...
        public ArcaneBlast(SpellCaster owner,string name, RPNString manaCost, RPNString damage,
                           Damage.Type damageDamageType, RPNString speed, RPNString cooldown, RPNString? lifetime, RPNString count, ProjectileData secondary,
        ...
        public virtual int GetSecondaryCount() => (int)Count.Evaluate(GetRPNVariables());
