...
namespace CMPM.Spells.Modifiers {
    public class SpellRepeaterModifier : SpellModifier {
        ...
        static IEnumerator SpawnProjectileDelay(float delay, int count, Action<ProjectileType, Vector3, Vector3> action,
                                                ProjectileType type, Vector3 where, Vector3 target) {
